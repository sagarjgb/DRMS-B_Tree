...
public class b_tree {
    static int countno() throws FileNotFoundException, IOException {
        ...
        no1 = 0;
        try {
            File fle = new File("C:\\Users\\Computer\\drms\\src\\record.txt");
        ...
        BufferedReader reader = new BufferedReader(
                new FileReader("C:\\Users\\Computer\\drms\\src\\record.txt"));
        String line;
                ...
                case 1:
                    ...
                    try {
                        FileWriter fw = new FileWriter(
                                "C:\\Users\\Computer\\drms\\src\\record.txt", true);
                        fw.write("" + key);
                        fw.write("|");
                        fw.write(name);
                        fw.write("|");
                    ...
                    break;
                case 2:
                    System.out.print("Enter The doctor ID to be searched: ");
                    key = sc.nextInt();

                    b.search(key);
                    bbr = new BufferedReader(new FileReader(
                            "C:\\Users\\Computer\\drms\\src\\record.txt"));
                    for (int i = 0; i < no; i++) {
                        String lineRead = bbr.readLine();
                    ...
                    break;
                case 3:
                    System.out.println("DOCTOR ID\tDOCTOR Name\tFEES\tSPECIALISATION\tPHONE\n");
                    bbr = new BufferedReader(new FileReader(
                            "C:\\Users\\Computer\\drms\\src\\record.txt"));
                    for (int i = 0; i <= no; i++) {
                        String lineRead = bbr.readLine();
                        ...
                        System.out.println(recs[i].keyf + "\t\t" + recs[i].name + "\t\t" + recs[i].fee + "\t\t"
                                + recs[i].spec + "\t\t" + recs[i].phone + "\t\t\t");
                    }
                    bbr.close();
                    break;
